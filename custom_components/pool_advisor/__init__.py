...
from .calculator import Recommendation, recommend_alkalinity, recommend_ph, recommend_shock
from .const import (
    CHLORINATION_SALT,
    CONF_CC_SHOCK_AT,
    CONF_CHLORINATION,
...
class PoolAdvisorData:
    ...
    def recalculate(self) -> None:
        ...
        ph_rec = recommend_ph(
            current=self._read(CONF_ENT_PH),
        ...
        self.recommendations = {"ph": ph_rec, "alkalinity": ta_rec, "chlorine": cl_rec}
